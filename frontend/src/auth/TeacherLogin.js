  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const decodedTeacherId = base64.decode(responseData.teacher_id_base64);
        const decodedTeacherEmail = base64.decode(responseData.teacher_email_base64);
        localStorage.setItem('teacherId', decodedTeacherId);
        localStorage.setItem('teacherEmail', decodedTeacherEmail);
