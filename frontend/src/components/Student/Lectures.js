...
function Lecture() {
  ...
  return (
    <div className="mx-2 my-1 p-6 bg-white rounded-md lectureheight">
      <h2 className="text-2xl font-bold bg-pink-600 text-white py-2 rounded-md text-center">Upcoming Lectures</h2>
      <div className="mt-2">
